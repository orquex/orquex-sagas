...
class HttpClientDeleteActivityTest {
  ...
  static void beforeAll() {
    ...
    httpClientDeleteActivity = new HttpClientDeleteActivity(registry, objectMapper);
  }
  ...
  void shouldExecuteSuccessfulHttpDelete() {
    ...
    // When
    final var result = httpClientDeleteActivity.execute(taskRequest);
